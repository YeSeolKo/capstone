...
export default function CharacterV4(props) {
    ...
    switch (props.meshName) {
        ...
        case 'hair_01_garma':
            mesh=(
                <mesh name='hair_01_garma' geometry={nodes.hair_01_garma.geometry} material={materials.Hair} position={[-3.13, -0.44, -0.02]} rotation={[Math.PI / 2, 0, 0]} scale={9.43} />
            );
            break;
        //hair_02_ex_male 기타남자스타일
        case 'hair_02_ex_male':
            mesh=(
                <mesh name='hair_02_ex_male' geometry={nodes.hair_02_ex_male.geometry} material={materials['hair-cards.001']} position={[-3.04, 0.83, -0.15]} rotation={[-2.63, 0.27, 1.34]} scale={1.25} />
            );
            break;
        //hair_03_ex_layered 기타레이어드 (여성) 
        case 'hair_03_ex_layered':
            mesh=(
                <mesh name='hair_03_ex_layered' geometry={nodes.hair_03_ex_layered.geometry} material={materials['Default_OBJ.020']} position={[-3.01, -0.35, -0.21]} rotation={[Math.PI, -1.5, Math.PI]} scale={0.1} />
            );
            break;
        ...
        case 'hair_09_leaf':
            mesh=(
                <mesh name='J' geometry={nodes.hair_09_leaf.geometry} material={materials['material_0.003']} position={[-3.14, 0.01, -0.35]} rotation={[-1.45, 0, 0]} scale={1.01} />
            );
            break;
        //hair_11_body 바디(여성)
        case 'hair_11_body':
        ...
        case 'hair_13_bony':
            mesh=(
                <mesh name='hair_13_bony' geometry={nodes.hair_13_bony.geometry} material={materials['Default_OBJ.001']} position={[-3.1, 0.02, -0.18]} rotation={[Math.PI, -1.4, Math.PI]} scale={0.12} />
            );
            break;
        //hair_15_build
        case 'hair_15_build':
            mesh=(
                <mesh name='hair_15_build' geometry={nodes.hair_15_build.geometry} material={materials['Default_OBJ.022']} position={[-3.03, -0.33, -0.44]} rotation={[Math.PI, -1.53, Math.PI]} scale={0.09} />
            );
            break;
        //hair_20_spin_swallow
        case 'hair_20_spin_swallow':
            mesh=(
                <mesh name='hair_20_spin_swallow' geometry={nodes.hair_20_spin_swallow.geometry} material={materials['material_0.001']} position={[-3.09, 0.75, -0.21]} rotation={[-1.72, 0, 0]} scale={7.48} />
            );
            break;
        //hair_EX_long_ddong
        case 'hair_EX_long_ddong':
            mesh=(
                <mesh name='hair_EX_long_ddong' geometry={nodes.long_ddong.geometry} material={materials['Default_OBJ.021']} position={[-3.16, 0.24, -0.36]} rotation={[Math.PI, -1.49, Math.PI]} scale={0.1} />
            );
            break;
        //hair_EX_male
        case 'hair_EX_male':
            mesh=(
                <mesh name='hair_EX_male' geometry={nodes.Object_2003.geometry} material={materials['material_0.005']} position={[-3.04, 0.62, -0.15]} rotation={[-1.93, 0.02, -0.2]} scale={7.66} />
            );
            break;
        //hair_25_onelength
        ...
        case 'C':
            mesh=(
                <mesh name='C'geometry={nodes.backhair.geometry} material={materials['Material_1.001']} position={[-0.08, 0.57, -0.24]} rotation={[1.42, 0.62, -1.31]} scale={[1.59, 1.65, 1.62]} />
            );
            break;

        case 'D':
            mesh=(
                <mesh name='D' geometry={nodes.bang.geometry} material={materials['Material_2.001']} position={[0.26, 0.71, 0.6]} rotation={[-0.17, 0.12, -1.21]} scale={[1.59, 1.65, 1.62]}/>
            );
            break;
